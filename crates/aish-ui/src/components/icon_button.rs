...
//!
//! M31：旁挂 `IconButtonEntity` stateful 版本（与 ButtonEntity 对称）。
...
// ============================================================================
// M31：IconButtonEntity — stateful 版 IconButton，press / focus 动画。
// ============================================================================

/// M31：stateful IconButton — 与 ButtonEntity 对称（press + focus_animated）。
pub struct IconButtonEntity {
    id: ElementId,
    icon_name: IconName,
    variant: ButtonVariant,
    size: IconButtonSize,
...
impl gpui::Focusable for IconButtonEntity {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl Render for IconButtonEntity {
