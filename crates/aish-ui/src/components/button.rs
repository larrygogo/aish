...
//!
//! M31：旁挂 `ButtonEntity` stateful 版本 — `cx.new(|cx| ButtonEntity::new(id, cx)...)`
...
// ============================================================================
// M31：ButtonEntity — stateful 版 Button，支持 press / focus 动画。
// ============================================================================

/// M31：stateful Button — caller 持 `Entity<ButtonEntity>` 字段。
///
/// 状态：
...
impl gpui::Focusable for ButtonEntity {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl Render for ButtonEntity {
...
mod tests {
    ...
    // ============================================================================
    // M31 — ButtonEntity 状态机 pure fn 单测（D-9 模拟）。
    // ============================================================================
