...
//! - `IsshUiAssets` 实现 `gpui::AssetSource`，把 SVG 编入 binary
//! - `icon(name)` 返回 GPUI svg 元素
//!
//! 调用方流程：
//! 1. `Application::with_assets(IsshUiAssets).run(...)`
...
pub struct IsshUiAssets;

impl AssetSource for IsshUiAssets {
